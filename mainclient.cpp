 ...
 * Daniel Artuso
 *
 * TCP-based client of socket programming.
 * This client interacts with the mainserver.cpp
 * which should be running first.
 *
 * Usage: g++ mainclient.cpp const.h -o mainClient.out
 * Based on version by Carey Williamson - January 13, 2012 */
...
/**
 * Client program connects to server and sends string follow by iterations of choices
 * @return
 * Returns
 */
int main() {
